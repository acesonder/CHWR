...
<body>
    ...
    <div class="container" style="margin-top: 2rem;">
        ...
        <div class="feature-card" style="margin-top: 2rem; text-align: center; padding: 3rem;">
            <i class="fas fa-list-check" style="font-size: 4rem; color: var(--text-light); margin-bottom: 1rem;"></i>
            <p style="color: var(--text-secondary);">Task management feature coming soon. Tasks will be auto-generated based on your assessment and assigned by your outreach worker.</p>

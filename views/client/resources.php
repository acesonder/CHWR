...
<body>
    ...
    <div class="container" style="margin-top: 2rem;">
        <h1><i class="fas fa-book"></i> Resources</h1>
        <div class="feature-card" style="margin-top: 2rem; text-align: center; padding: 3rem;">
            <i class="fas fa-hands-helping" style="font-size: 4rem; color: var(--text-light); margin-bottom: 1rem;"></i>
            <p style="color: var(--text-secondary);">Resource directory coming soon. You'll have access to information about local services, shelters, food banks, and support programs.</p>
